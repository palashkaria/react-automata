...
var State$1 = /*#__PURE__*/createConditional({
  ...
  return function (Component) {
    var StateMachine = function (_React$Component) {
      ...
      function StateMachine() {
        ...
        return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.machine = statechart instanceof StateNode ? statechart : Machine(statechart), _this.state = {
...
var testStatechart = function testStatechart(options, Component) {
  ...
  var machine = Machine(statechart);
  var paths = getShortestPaths(machine, extendedState);
...
export { Action, State$1 as State, testStatechart, withStatechart };
